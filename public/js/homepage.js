...
const camOffImg = "../images/camera-off.png";
const audioOffImg = "../images/sound-off-icon-40.png";
 ...
 */
 function getAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>Made By Using WebRtc</strong>",
    imageAlt: "about",
    imageUrl: aboutImg,
    html: `
    <br/>
    <div id="about">
      <b>MS Teams</b> Clone
      <a href="https://github.com/shikha080" target="_blank"><br/></br>
      <img alt="About github" src="../images/5-2-github-picture.png"></a><br/><br/>
      <button id="sBtn" class="far fa-heart pulsate" onclick="window.open('https://github.com/shikha080')"> Know More</button>
    </div></br>
    <div id="author">Made By<a href="https://www.linkedin.com/in/shikha-0882851a2/" target="_blank"> Shikha</a></div>
    `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
